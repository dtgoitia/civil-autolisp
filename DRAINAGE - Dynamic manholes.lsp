(defun _CursorText_L1 ( p txt1 textsize )
  (entmakex
    (list (cons 0 "TEXT")
      (cons 40 (setq dis textsize))                           ; Altura del texto
      (cons 10 (polar (polar p 0 dis) (* -0.5 pi) (* 2 dis))) ; Punto de inserción del texto
      (cons 50 0)                                             ; Rotación del texto
      (cons 62 251)                                           ; Color del texto
      (cons 1 txt1)                                           ; Contenido del texto
      (cons 7 "ARIAL")                                        ; Estilo del texto
    )
  )
)
(defun _CursorText_L2 ( p txt2 textsize )
  (entmakex
    (list (cons 0 "TEXT")
      (cons 40 (setq dis textsize))                           ; Altura del texto
      (cons 10 (polar (polar p 0 dis) (* -0.5 pi) (* 4 dis))) ; Punto de inserción del texto
      (cons 50 0)                                             ; Rotación del texto
      (cons 62 251)                                           ; Color del texto
      (cons 1 txt2)                                           ; Contenido del texto
      (cons 7 "ARIAL")                                        ; Estilo del texto
    )
  )
)
